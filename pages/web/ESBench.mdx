...
import banner from "../../assets/esbench.png";
...
拥有完善的文档，丰富的示例，清晰的注释，可靠的测试。带 Playground 可在线运行；还提供 IDEA 和 VSCode 插件。
...
export default function ({ children }) {
	...
	return <ProjectIntro name="基准测试框架 ESBench" stack={stack} links={links} banner={banner}>{children}</ProjectIntro>;
}
